...
@echo Part 2.Compiling kernel
	...
	dev\compillers\mingw\bin\ld -Tlink.ld -o binary/krnl.out binary/kernel.o binary/cls.o binary/print.o binary/kbd.o binary/tty.o binary/io.o binary/graphics.o binary/kasm.elf
